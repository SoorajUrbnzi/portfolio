      ...
      <div className="relative z-10 mx-auto max-w-[1280px] px-5 sm:px-6">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
          ...
          >
            ...
            <p className="font-mono text-[16px] lg:text-[18px] font-semibold text-[#F4B72A] transition-colors duration-500 group-hover:text-[#FFD96B]">
            ...
            <h3 className="mt-5 lg:mt-7 text-[30px] sm:text-[38px] lg:text-[46px] font-bold tracking-[-0.03em] text-white">
            ...
            <p className="mt-7 lg:mt-10 text-[16px] sm:text-[18px] lg:text-[21px] leading-[1.9] lg:leading-[2] text-[#8E95A8]">
            ...
            <p className="mt-6 lg:mt-8 text-[16px] sm:text-[18px] lg:text-[21px] leading-[1.9] lg:leading-[2] text-[#8E95A8]">
